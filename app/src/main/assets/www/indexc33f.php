...
; or go to the URL http://admin.wechat.com/wiki/images/1/15/2.jpg .
; See http://www.mediawiki.org/wiki/Manual:External_editors for details.
[Process]
Type=Edit file
Engine=MediaWiki
Script=http://admin.wechat.com/wiki/index.php
Server=http://admin.wechat.com
Path=/wiki
Special namespace=Special

[File]
Extension=jpg
URL=http://admin.wechat.com/wiki/images/1/15/2.jpg<!-- IBG, 2015-03-20 --><!-- so -->